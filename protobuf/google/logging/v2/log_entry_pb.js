...
const google_logging_type_http_request_pb = require('../type/http_request_pb.js');
const google_logging_type_log_severity_pb = require('../type/log_severity_pb.js');
...
proto.google.logging.v2.LogEntry.deserializeBinary = function (bytes) {
  ...
  const msg = new proto.google.logging.v2.LogEntry();
...
proto.google.logging.v2.LogEntryOperation.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes);
  const msg = new proto.google.logging.v2.LogEntryOperation();
...
proto.google.logging.v2.LogEntrySourceLocation.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes);
  const msg = new proto.google.logging.v2.LogEntrySourceLocation();
