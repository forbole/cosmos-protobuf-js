...
proto.ibc.core.channel.v1.Channel.deserializeBinary = function (bytes) {
  ...
  const msg = new proto.ibc.core.channel.v1.Channel();
...
proto.ibc.core.channel.v1.IdentifiedChannel.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes);
  const msg = new proto.ibc.core.channel.v1.IdentifiedChannel();
...
proto.ibc.core.channel.v1.Counterparty.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes);
  const msg = new proto.ibc.core.channel.v1.Counterparty();
...
proto.ibc.core.channel.v1.Packet.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes);
  const msg = new proto.ibc.core.channel.v1.Packet();
...
proto.ibc.core.channel.v1.PacketState.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes);
  const msg = new proto.ibc.core.channel.v1.PacketState();
...
proto.ibc.core.channel.v1.Acknowledgement.deserializeBinary = function (bytes) {
  const reader = new jspb.BinaryReader(bytes);
  const msg = new proto.ibc.core.channel.v1.Acknowledgement();
