...
export class QuerySigningInfoResponse extends jspb.Message {
  ...
  setValSigningInfo(value?: cosmos_slashing_v1beta1_slashing_pb.ValidatorSigningInfo): void;
...
export class QuerySigningInfosResponse extends jspb.Message {
  ...
  setInfoList(value: Array<cosmos_slashing_v1beta1_slashing_pb.ValidatorSigningInfo>): void;
