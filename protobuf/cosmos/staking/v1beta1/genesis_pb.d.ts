...
export class GenesisState extends jspb.Message {
  ...
  setDelegationsList(value: Array<cosmos_staking_v1beta1_staking_pb.Delegation>): void;
  ...
  setUnbondingDelegationsList(value: Array<cosmos_staking_v1beta1_staking_pb.UnbondingDelegation>): void;
  ...
  setRedelegationsList(value: Array<cosmos_staking_v1beta1_staking_pb.Redelegation>): void;
